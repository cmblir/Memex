...
pub const SAMPLE_NOTES: &[(&str, &str)] = &[
    ("wiki/transformer-architecture.md", r#"---
...
[^src-attention-is-all-you-need]: [[source-attention-is-all-you-need]]
"#),
    ("wiki/multi-head-attention.md", r#"---
...
[^src-attention-is-all-you-need]: [[source-attention-is-all-you-need]]
"#),
    ("wiki/residual-connections.md", r#"---
...
[^src-scaling-laws-paper]: [[source-scaling-laws-paper]]
"#),
    ("wiki/inference-optimization.md", r#"---
...
[^src-attention-is-all-you-need]: [[source-attention-is-all-you-need]]
"#),
    ("wiki/source-attention-is-all-you-need.md", r#"---
...
[^src-attention-is-all-you-need]: [[source-attention-is-all-you-need]]
"#),
    ("wiki/source-scaling-laws-paper.md", r#"---
...
[^src-scaling-laws-paper]: [[source-scaling-laws-paper]]
"#),
    ("wiki/source-constitutional-ai-paper.md", r#"---
...
[^src-constitutional-ai-paper]: [[source-constitutional-ai-paper]]
"#),
    ("wiki/analysis-scaling-vs-data.md", r#"---
...
[^src-scaling-laws-paper]: [[source-scaling-laws-paper]]
"#),
    ("wiki/analysis-rlhf-vs-dpo.md", r#"---
title: "RLHF vs. DPO"
type: analysis
tags:
  - analysis
